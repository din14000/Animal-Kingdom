...
public class CritterMain {
    public static void main(String[] args) {
        ...
        // uncomment each of these lines as you complete these classes - FINISHED!
        frame.add(20, Bear.class);
        frame.add(15, Tiger.class);
        frame.add(10, WhiteTiger.class);
        frame.add(10, Giant.class);
        frame.add(10, NinjaCat.class);
